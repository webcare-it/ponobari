                    ...
                    <div class="card radius-10 mb-0">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-auto">
                                    <a href="{{ url('/top/products/create') }}" class="btn btn-primary btn-sm">Add new</a>
                                </div>
                            </div>
                                   ...
                                   <tbody>
                                       @foreach ($products as $product)
                                        <tr>
                                            ...
                                            <td>
                                                @if($product->product)
                                                    <img src="{{ asset('/product/images/'.$product->product->image) }}" height="50" width="50" />
                                            ...
                                            <td>
                                                ...
                                                @endif --}}
                                                <a href="{{url('top/products/delete/'.$product->id)}}" onclick="return confirm('Are you sure delete this product ?')" class="badge rounded-pill bg-danger">
